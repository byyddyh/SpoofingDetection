...
public class Lla2EcefConverter {
   ...
   *
   * <p>Inputs is GeodeticLlaValues class {@link Ecef2LlaConverter.GeodeticLlaValues} containing geodetic latitude
   * (radians), geodetic longitude (radians), height above WGS84 ellipsoid (m)
   *
   * <p>Output is cartesian coordinates x,y,z in meters
   */
  public static double[] convertFromLlaToEcefMeters(Ecef2LlaConverter.GeodeticLlaValues llaValues) {
